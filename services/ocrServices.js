            ...
            messages: [
              {
                ...
                content: [
                  ...
                  { type: 'text', text: 'Extract text, images, and equations from the image.Read and format the page number as "Page No.",quiz id as "Quiz ID",test id as "Test ID",roll no as "Roll No" and set as "Set" in the output.  Correct spelling and grammar mistakes and highlight the corrected words in red using inline CSS (e.g., <span style="color:red;">corrected word</span>). For unclear handwriting, provide multiple possible interpretations of ambiguous words or phrases, displaying them in parentheses (e.g., word1/word2). Exclude content that is scratched, scribbled over, or manually crossed out, as it should not be considered part of the student intended response. If an answer is written by the student below or beside the cut part, include it in the output as part of the student response.Ensure the output provides the complete answer of the student response while balancing predictive assistance with accuracy.' },
                  { type: 'image_url', image_url: { url: base64Image } },
                ],
              },
            ],
            ...
            messages: [
              {
                ...
                content: [
                  ...
                  { type: 'text', text: 'Extract text, images, and equations from the image.Read and format the page number as "Page No.",quiz id as "Quiz ID",test id as "Test ID",roll no as "Roll No" and set as "Set" in the output.Provide multiple possible interpretations for ambiguous words or phrases, displaying them in parentheses (e.g., word1/word2), to assist evaluators in selecting the appropriate option. Exclude content that is scratched, scribbled over, or manually crossed out, as it should not be considered part of the student intended response. If an answer is written by the student below or beside the scribbled or cut part, include it in the output as part of the student response.Focus on precise extraction without applying predictive corrections. Ensure basic handwriting misinterpretations are minimized to maintain accuracy in the student intended response.Do not interpret or modify the content beyond what is clearly written by the student.' },
                  { type: 'image_url', image_url: { url: base64Image } },
                ],
              },
            ],
