            ...
            messages: [
              {
                ...
                content: [
                  ...
                  { type: 'text', text: 'Extract text, images, and equations from the image.Extract the "Set:", "Quiz ID:", "Quiz Name:", "Class:", "Section:", "Subject Name:", "Test ID:", "Roll No:", "Page No:" in the exact mentioned order and format while giving the output.Correct spelling and grammar mistakes and highlight the corrected words in red using inline CSS (e.g., <span style="color:red;">corrected word</span>). For unclear handwriting, provide multiple possible interpretations of ambiguous words or phrases, displaying them in parentheses (e.g., word1/word2).Omit content that is scratched, scribbled over, or manually crossed out. Do not include parts of the text that are visibly altered by strikethroughs or manual cuts, as these indicate the student intent to remove them.If an answer is written by the student below or beside the scratched-out or manually cut part, include it in the output as part of the student response, provided it is clearly legible and not crossed out.Apply predictive corrections only to the final content clearly intended by the student while excluding manually crossed-out portions. Correct the intended response to improve readability while maintaining accuracy.Ensure the output provides the complete answer of the student response while balancing predictive assistance with accuracy and respecting the student original intent.' },
                  { type: 'image_url', image_url: { url: base64Image } },
                ],
              },
            ],
            ...
            messages: [
              {
                ...
                content: [
                  ...
                  { type: 'text', text: 'Extract text, images, and equations from the image.Extract the "Set:", "Quiz ID:", "Quiz Name:", "Class:", "Section:", "Subject Name:", "Test ID:", "Roll No:", "Page No:" in the exact mentioned order and format while giving the output.Provide multiple possible interpretations for ambiguous words or phrases, displaying them in parentheses (e.g., word1/word2), to assist evaluators in selecting the appropriate option.Omit any content that is scratched, scribbled over, or manually crossed out. Do not include any part of the text that is visibly altered by a strikethrough or cross mark, as this indicates the student intent to remove it. Only include the final content that is clearly legible and intended for submission.If an answer is written by the student below or beside the scratched or cut-out part, include it in the output as part of the student response, as long as it is not crossed out.Do not apply predictive corrections. Ensure that the text is extracted exactly as written by the student, preserving the original spelling, punctuation, and handwriting as much as possible. Only focus on precise extraction to maintain accuracy.Avoid interpreting or modifying the content beyond what is clearly written by the student. If there is ambiguity, include it verbatim, and where necessary, provide an alternative reading in parentheses to preserve accuracy.' },
                  { type: 'image_url', image_url: { url: base64Image } },
                ],
              },
            ],
