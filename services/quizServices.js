...
// exports.startQuizEvaluationProcess = async (event) => {
//     try {
//         const response = {
//             statusCode: 200,
//             body: JSON.stringify({ message: "Evaluation started" }),
//         };

//         (async () => {
//             try {
//                 // const body = event.body ? JSON.parse(event.body) : {};
//                 // await axios.post("https://api.example.com/start", body);
//                 // console.log("Background API call completed");

//                 await sns.publish({
//                     TopicArn: process.env.EVALUATION_TOPIC_ARN,
//                     Message: JSON.stringify(body),
//                 }).promise();

//                 console.log("SNS message sent for evaluation process");
...
exports.startQuizEvaluationProcess = async (event) => {
    ...
    let studentMetaRes = await quizResultRepository.fetchStudentQuiRresultMetadata2(event);
    if (studentMetaRes.Items.length === 0) {
        throw helper.formatErrorResponse(constant.messages.NO_ANSWER_SHEET_FOUND, 400);
    }
    ...
    try {
        ...
        console.log("SNS message sent for evaluation process quiz");
